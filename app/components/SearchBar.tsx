...
export default function SearchBar() {
   ...
   return (
      <div className="sticky top-20 min-[1162px]:top-2 z-30 flex justify-center m-1 p-1">
         <motion.div
            style={{ scale }}
            className="flex items-center w-auto origin-center bg-[var(--color-surface)] rounded-full shadow-lg border border-border overflow-visible"
         >
            {/* WHERE */}
            <div className="min-w-[250px] px-5 py-2 relative">
            ...
            <div className="relative px-5 py-2 min-w-[180px]">
